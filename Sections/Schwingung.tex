...
\subsection{DGL mit konstanten Koeffizienten}
...
\noindent Mittels dem Satz von Steiner kann auch eine Drehung um eine Drehachse, welche nicht die Schwerachse ist, berechnet werden. Sie müssen jedoch parallel sein! \kuchling{131}
\begin{formula}
	{J_A = J_S + md^2}
